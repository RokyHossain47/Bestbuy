...
<div class="ml-sm-4 mr-sm-4">
  ...
  <form method="POST" enctype="multipart/form-data" action="{{route('addproduct')}}" class="content mb-1">
    @csrf
    <div class="row">
      <div class="col-md-8">
        <div class="card card-success">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" id="inputName" require name="p_name" placeholder="Product Title"  class="form-control">
            </div>
            <div class="form-group">
              <label for="inputDescription">Product Description</label>
                <textarea id="summernote" require name="long_description" class="summerheight">
                  Product Description
                </textarea>
            </div>
            <div class="form-group">
              <label for="inputDescription">Product Short Description</label>
              <textarea id="summernote2" require name="short_description" class="summerheight">
            ...
            <div class="card-header">
              ...
              <div class="card pt-3 pb-3">
                <div class="col-12 pr-sm-3 pl-sm-4 pb-3">
                    ...
                    <input type="number" id="inputName" require name="quantity" class="form-control" placeholder="00.0">
                </div>
                <div class="col-12 pr-sm-3 pl-sm-4 pb-3">
                    <label for="inputName">MRP</label>
                    <input type="number" id="inputName" require name="mrp_price" class="form-control" placeholder="00.0">
                </div>
                <div class="col-12 pr-sm-3 pl-sm-4 pb-3">
                    <label for="inputName">Selling Price</label>
                    <input type="number" id="inputName" require name="s_price" class="form-control" placeholder="00.0">
                </div>
                <div class="col-12 pr-sm-3 pl-sm-4 pb-3">
                  <label for="inputName">Buying Price</label>
                  <input type="number" id="inputName" require name="b_price" placeholder="00.0"  class="form-control">             
                </div>
