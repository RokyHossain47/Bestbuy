...
<head>
    ...
    <link rel="stylesheet" href="{{asset('dist/css/custome.css')}}" type="text/css">
...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="{{asset('dist/img/hero/logo.png')}}" alt="ther in logo"></a>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i> {{$siteidenty->email}}</li>
                                <li>{{$siteidenty->text}}</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            <div class="header__top__right__social">
                                <a href="{{$siteidenty->facebook}}"><i class="fa fa-facebook"></i></a>
                                <a href="{{$siteidenty->twitter}}"><i class="fa fa-twitter"></i></a>
                                <a href="{{$siteidenty->linkedin}}"><i class="fa fa-linkedin"></i></a>
                                <a href="{{$siteidenty->pinterest}}"><i class="fa fa-pinterest-p"></i></a>
                            </div>
                            <div class="header__top__right__language">
                                <img src="{{asset('dist/img/language.png')}} " alt="">
                                <div>English</div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="{{route('home')}}">
                        <img src="{{asset('storage/product-image/'. $siteidenty->image)}}" width="100px" alt="">
                    </a>
                    </div>
                </div>
                <!-- manu section -->
                        ...
                        <ul>
                            ...
                            <li><a href="#">Pages</a>
                                <ul class="header__menu__dropdown">
                                    ...
                                    <li><a href="{{route('chackout')}}">Check Out</a></li>
                                </ul>
                            </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer__copyright">
                        ...
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart" aria-hidden="true"></i> by Bestbuy
